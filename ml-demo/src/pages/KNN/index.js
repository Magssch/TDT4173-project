      ...
      <Grid container alignItems="center" direction="column" spacing={5}>
        <Grid item alignItems="right" xs={8}>
          <Typography align="left">
            kNN falls within the supervised learning category in machine learning. This means that the algorithm uses a
            training set to determine a predictive model for new data points. Although kNN is mainly used for
            classification as in the example above, it may also be used in combination with other machine learning
            algorithms for regression. kNN is a lazy learning algorithm, which means that there is no explicit training
            phase. Instead of training a model, kNN uses all of the training data during test phase. The core of the kNN
            algorithm is simply measuring the distance between tested examples and training examples. Although its
            simplistic nature, kNN has proven to be a very effective machine learning algorithm
          </Typography>
          <Typography align="left">
            ...
            choose any value of k. Press calculate to find out wheter the maker will be classified as either blue or
            red, based on the nearest k neighbors.
          </Typography>
        </Grid>
        ...
        <Grid container direction="row" justify="center">
          ...
          <Grid item xs={4} xt={4}>
            <div style={{ display: "flex", marginTop: "250px", marginLeft: "-200px" }}>
              <input
                type="range"
                min={0}
                max={500}
